...
"QPushButton:enabled {color: rgb(0, 0, 0); background-color: rgb(182, 182, 182) }")
		...
		self.set_syntec_OverGlobalVar = QtWidgets.QCheckBox(self.frameSyntec)
		self.set_syntec_OverGlobalVar.setChecked(True)
		self.set_syntec_OverGlobalVar.setObjectName("set_syntec_OverGlobalVar")
		self.verticalLayout_4.addWidget(self.set_syntec_OverGlobalVar)
...
"Этап 1 + Этап 2"))
		...
		self.set_syntec_OverGlobalVar.setText(_translate("MainWindow", "Глобальные переменные > 500 (-300)"))
