...
"Этап 1 + Этап 2"))
        ...
        self.tabSettings.setTabText(self.tabSettings.indexOf(self.tab_nc), _translate("MainWindow", "NC"))
        ...
        self.tabSettings.setTabText(self.tabSettings.indexOf(self.tab_syntec), _translate("MainWindow", "Syntec"))
